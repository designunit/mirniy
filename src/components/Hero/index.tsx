            ...
            <div className={s.up}>
                ...
                >
                    <div className={s.description}>
                        <p>
                            Всем привет! Это команда развития города Мирный, сформированная при поддержке компании АЛРОСА. Мы хотим улучшить город Мирный и превратить его в самый комфортный северный город на Земле.
                        </p>
                        <p>
